...
import com.example.marvelapp.databinding.ItemCharacterMiddleBinding
...
class CharactersMiddleViewHolder(
    itemCharactersBinding: ItemCharacterMiddleBinding,
    ...
    companion object {
        ...
        ): CharactersMiddleViewHolder {
            val inflater = LayoutInflater.from(parent.context)
            val itemBinding = ItemCharacterMiddleBinding.inflate(inflater, parent, false)
            return CharactersMiddleViewHolder(itemBinding, imageLoader, onItemClick)
        }
    }
}